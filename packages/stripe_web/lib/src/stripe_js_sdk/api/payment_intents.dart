...
abstract class PaymentIntent {
  ...
  external Iterable<String> get payment_method_types;
  external set payment_method_types(Iterable<String> v);
  ...
  external factory PaymentIntent(
      ...
      Iterable<String> payment_method_types,
...
abstract class NextAction {
  ...
  external WechatPayDisplayQrCode get wechat_pay_display_qr_code;
  external set wechat_pay_display_qr_code(WechatPayDisplayQrCode v);
...
@anonymous
@JS()
abstract class WechatPayDisplayQrCode {
  ...
  external String get image_data_url;
  external set image_data_url(String v);
  external factory WechatPayDisplayQrCode({String data, String image_data_url});
}
